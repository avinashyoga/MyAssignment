...
public class editLead {
	...
	public static void main(String[] args) {
		...
		//first name local
		driver.findElement(By.id("createLeadForm_firstNameLocal")).sendKeys("AVINASH");
		//department
		...
		//email ID
		driver.findElement(By.id("createLeadForm_primaryEmail")).sendKeys("avinashyoga2@gmail.com");
		//locate drop down
